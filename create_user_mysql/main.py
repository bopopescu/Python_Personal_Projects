...
DATABASE_CONFIG = {
	...
	# Desativado: 'jabnetbd01': { 'user': 'usr_etl', 'password': 'lmsistemas01', 'host': '10.229.6.131', 'port': 3306, 'database': 'mysql'},
	# Desativado: 'jabnetbd02': { 'user': 'usr_etl', 'password': 'lmsistemas01', 'host': '10.229.6.161', 'port': 3306, 'database': 'mysql'},
